...
void main() {
  ...
  test('parse question type rating without error', () {
    var json =  {
      "type": "rating",
      "name": "questionRating",
      "title": "Experience",
      ...
      "isRequired": true,
      "requiredErrorText": "please select rating ",
      "rateMax": 10,
      "rateStep": 2,
    ...
    QuestionRatingModel mockModel = QuestionRatingModel(json);
    expect(QuestionRatingModel(json), mockModel);
  });
  ...
  test('parse multiple question type', () {
    ...
    QuestionRatingModel questionRatingModel= QuestionRatingModel(elements.firstWhere((question){
      return question["type"]=="rating";
    }));
    questions.add(questionRatingModel);
  ...
  test('parse pages successfully', () {
    ...
    QuestionRatingModel ratingModel =
        QuestionRatingModel(elements.firstWhere((question) {
      return question["type"] == "rating";
    }));
    questions.add(ratingModel);
